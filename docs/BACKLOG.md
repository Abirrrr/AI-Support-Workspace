...
The supplemental [M14-Q audit](PERFORMANCE_AUDIT_M14-Q.md) provides the evidence and limitations for these follow-ups. F3 was completed by M14-S at `ccc1930`; F1 was completed, Principal-approved, checkpointed, and pushed by M14-T at `50eaf76`; and F2 has completed its diagnostic attribution under M14-U without implementing an optimization. Remaining engineering options are **PROPOSED / UNAPPROVED / UNSCHEDULED**. They do not change M14-P.6.1 approval, Decision 57, the existing architecture, or M15's NOT STARTED state.
