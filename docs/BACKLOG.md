...
- **M14-P.5 — Performance Closure & Roadmap Documentation (ACTIVE / DOCUMENTATION ONLY):** no second broad/speculative Text optimization milestone occurs before M14-O. M14-P.1 is authoritative; Text remains the highest performance priority; Image quality/correctness/safety and the current one-shot native model remain accepted. Further optimization is evidence-dependent and belongs only to a focused task after the final gate localizes a meaningful user-visible regression.
...
M13 is complete at `b76fcb4`/`9a3c7ef`. M14-I is complete at `ebe915f`/`28dcf53`. M14-J is complete and real-browser validated. M14-K is closed at `e34cd76`. M14-M.0 remains PASS; M14-M.1 is the Dexie v6/Backup v7 foundation; M14-M.2 is checkpointed at `f4d9ab0`; M14-M.3/M14-M.3.1 at `2475f8b`; and M14-N.3 is complete at `d410ecb`. M14-P.1 is approved at `7bc5005`; M14-P.2 at `64b5dd8`; M14-P.3 at `406ff08`; and M14-P.4/M14-P.4.1/M14-P.4.2 at `52befe0`. M14-P.5 is active documentation-only work. M14-O follows with no intervening performance milestone, then the final M14-P gate with Text regression verification. M15 remains gated and incomplete.
