...
- **M14-N.3 — Real-Chrome Validation & Automatic Backup Closeout (NEXT):** repeat final production adapter evidence for restart, permission persistence/loss, unavailable location, same/different folder, alarm recovery, actual verified output, safe 7/4 retention, and M14-N closeout.
...
M13 is complete at `b76fcb4`/`9a3c7ef`. M14-I is complete at `ebe915f`/`28dcf53`. M14-J is complete and real-browser validated, including Crisp/Intercom no-refresh recovery and repeated-reload duplicate safety. M14-K is closed and complete at `e34cd76`. M14-M.0 remains PASS; M14-M.1 implements the shared Dexie v6/Backup v7 foundation; M14-M.2 is checkpointed at `f4d9ab0`; and M14-M.3/M14-M.3.1 is checkpointed at `2475f8b`. M14-M.4 changes engineering-environment documentation only. M14-N.1 runtime and M14-N.2 Options wiring are implemented with automated validation; M14-N.3 is next, while M14-O/P and M15 remain separately gated and unstarted.
