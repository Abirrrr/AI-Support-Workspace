...
- **M14 — Snippet Authoring and Delivery:** M14-G/G.2 implements lists, Backup v5, unified Text WYSIWYG, and one-image screenshot/file authoring. M14-H is absorbed. M14-I implements unified Text/Image planning and is complete at `ebe915f`; Text, Windows native Image delivery, Settings readiness, and the post-cleanup smoke test are real-Chrome validated. M14-I.1.5.2 retains browser feasibility history, M14-I.2 / Decision 43 defines the Windows Native Clipboard Companion, M14-I.3/M14-I.3.1 implement the native foundation, M14-I.4/M14-I.4.1 implement and validate development Chrome integration, and M14-I.5 removes superseded browser Image/probe runtime. M14-J is next but not started.
