...
- **M14-O — Generated Text Snippet Tags & Retrieval Integration (ACTIVE / IMPLEMENTATION NOT YET STARTED):** implement fingerprinted Text-only generated metadata, post-save provider-independent generation with configured-model resolution, exact bounded JSON-array validation, edit invalidation, explicit bounded historical backfill, and deterministic generated-tag weight 1. Authored tags remain separate; usage/recency remain outside ranking; Knowledge/Prompt Builder v1 remain unchanged.
