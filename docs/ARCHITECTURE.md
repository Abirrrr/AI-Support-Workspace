...
The revised implementation sequence is M14-G/G.2 structured content, Backup v5, unified authoring, and Image authoring; M14-I Unified Snippet Clipboard Delivery and Trigger Planner for both Text and Image; and M14-J destination compatibility validation. M14-H is absorbed into M14-G.2. Rich delivery covers paragraphs, marks, links, and lists only.
...
The platform architecture remains approved: WXT, Manifest V3, TypeScript, React, Tailwind CSS, pnpm, Dexie, Tiptap v3 as constrained UI infrastructure, React Context and Hooks, Vitest, Playwright, ESLint, Prettier, Husky, and lint-staged. Milestones 1 through 13 are implemented and validated. M14 is current under Decisions 36–41. M14-E is complete at `1828f09`; M14-F inline Rich-image authoring is cancelled; and the uncommitted M14-G/G.2 package implements lists, Backup v5, unified Text authoring, and Image authoring pending review. No implementation task is active. The next engineering action after approval is M14-I — Unified Snippet Clipboard Delivery and Trigger Planner.
