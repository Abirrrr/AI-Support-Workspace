...
- M14-L/L.1 assigns implementation-ready architecture to M14-M.0 through M14-P; it implements nothing. Decisions 50–53 are Principal-approved in substance and Decision 54 remains intact. M14-M.1/M14-M.1.1 are now checkpointed at `20b509c`, with Dexie v6 and Backup v7 implemented; M14-M usage behavior is next.
