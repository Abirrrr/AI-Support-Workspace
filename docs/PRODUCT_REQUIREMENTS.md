...
- M14-B migrates Dexie v3 string content to canonical plain content in implemented v4 without changing indexes or adding tables. It implements strict Backup Format v3 while keeping v1 and v2 frozen and importable. Rich authoring and rich browser rendering remain pending.
