...
M14-K.1 is documentation-only. It adds no Settings field/toggle, Backup v6 runtime, protocol v2 operation, `SendInput`, AutoHotkey, keyboard hook, native behavior, or automatic-paste runtime. Decisions 42, 43, and 44; native clipboard behavior; Dexie v5; and Backup v5 remain unchanged. Implementation is assigned to M14-K.2 after Principal approval; real Crisp/Intercom Text/Image and adversarial focus validation are assigned to M14-K.3.
